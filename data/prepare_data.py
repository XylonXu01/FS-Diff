...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', '-p', type=str,
                        default='/home/xys/IJCAI2024/medical_source+results/results/2-MRI-SPECT-552')
    parser.add_argument('--out', '-o', type=str,
                        default='/home/xys/IJCAI2024/VIS-IR-Super-Resolution-via-Iterative-Refinement/dataset/medical_image/MRI-SPECT/result')
